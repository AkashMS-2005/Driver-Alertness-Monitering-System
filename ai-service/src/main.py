...
def load_config() -> dict:
    ...
    try:
        ...
        return {
            ...
            "pitch_threshold":       float(hp_cfg.get("enter_pitch_threshold", hp_cfg.get("pitch_threshold", defaults["pitch_threshold"]))),
            "yaw_threshold":         float(hp_cfg.get("enter_yaw_threshold", hp_cfg.get("yaw_threshold", defaults["yaw_threshold"]))),
            "roll_threshold":        float(hp_cfg.get("enter_roll_threshold", hp_cfg.get("roll_threshold", defaults["roll_threshold"]))),
            "yaw_deadzone":          float(hp_cfg.get("yaw_deadzone", defaults["yaw_deadzone"])),
            "pitch_deadzone":        float(hp_cfg.get("pitch_deadzone", defaults["pitch_deadzone"])),
            "roll_deadzone":         float(hp_cfg.get("roll_deadzone", defaults["roll_deadzone"])),
            "enter_yaw_threshold":   float(hp_cfg.get("enter_yaw_threshold", defaults["enter_yaw_threshold"])),
            "exit_yaw_threshold":    float(hp_cfg.get("exit_yaw_threshold", defaults["exit_yaw_threshold"])),
            "enter_pitch_threshold": float(hp_cfg.get("enter_pitch_threshold", defaults["enter_pitch_threshold"])),
            "exit_pitch_threshold":  float(hp_cfg.get("exit_pitch_threshold", defaults["exit_pitch_threshold"])),
            "enter_roll_threshold":  float(hp_cfg.get("enter_roll_threshold", defaults["enter_roll_threshold"])),
            "exit_roll_threshold":   float(hp_cfg.get("exit_roll_threshold", defaults["exit_roll_threshold"])),
            "head_deviation_duration": float(hp_cfg.get("deviation_min_duration", hp_cfg.get("deviation_duration", defaults["head_deviation_duration"]))),
            "exit_duration":         float(hp_cfg.get("exit_duration", defaults["exit_duration"])),
            "smoothing_window_frames": int(hp_cfg.get("smoothing_window_frames", defaults["smoothing_window_frames"])),
            "calibration_frames":    int(hp_cfg.get("calibration_frames", defaults["calibration_frames"])),
...
def run_pipeline():
    ...
    # Head pose tracker (temporally stable distraction detection with deadzone & hysteresis)
    head_tracker = HeadPoseTracker(
        yaw_deadzone=cfg["yaw_deadzone"],
        pitch_deadzone=cfg["pitch_deadzone"],
        roll_deadzone=cfg["roll_deadzone"],
        enter_yaw_threshold=cfg["enter_yaw_threshold"],
        exit_yaw_threshold=cfg["exit_yaw_threshold"],
        enter_pitch_threshold=cfg["enter_pitch_threshold"],
        exit_pitch_threshold=cfg["exit_pitch_threshold"],
        enter_roll_threshold=cfg["enter_roll_threshold"],
        exit_roll_threshold=cfg["exit_roll_threshold"],
        deviation_min_duration=cfg["head_deviation_duration"],
        exit_duration=cfg["exit_duration"],
